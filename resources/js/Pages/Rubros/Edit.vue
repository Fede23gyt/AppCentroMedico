    ...
    <AuthenticatedLayout>
        <div class="max-w-4xl mx-auto px-4 py-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Editar Rubro</h1>
                    <p class="dark:text-gray-600">Modifica la categoría de prestaciones médicas</p>
                </div>
                <Link
                ...
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-md p-4">
                        <div class="text-sm text-gray-600 space-y-1">
                            ...
                            <p v-if="rubro.prestaciones_count !== undefined">
                                <strong>Prestaciones asociadas:</strong> {{ rubro.prestaciones_count }}
                            </p>
                            <p><strong>Creado:</strong> {{ formatDate(rubro.created_at) }}</p>
                            <p><strong>Última actualización:</strong> {{ formatDate(rubro.updated_at) }}</p>
                        </div>
                    </div>
...
const form = useForm({
    ...
    descripcion: props.rubro.descripcion,
    porc: props.rubro.porc || 0,
    estado: props.rubro.estado
})

const submit = () => {
    form.put(route('rubros.update', props.rubro.id))
}
